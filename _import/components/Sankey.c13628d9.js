...
import * as d3Sankey from "../../_node/d3-sankey@0.12.3/index.01c7f8ef.js";
...
export function SankeyChart({
    ...
    nodePadding = 8, // vertical separation between adjacent nodes
    nodeLabelPadding = 3, // horizontal separation between node and label
